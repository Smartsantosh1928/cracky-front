...
export function ListProducts(){
    return(
        <div className=" w-full bg-[#eaf7ff] p-5 rounded-lg">    
            <div>
                    <div className="flex ">
                        <Typography className="text-3xl font-secondary font-semibold">List Products</Typography>
                    </div>
                        <div className="w-10 flex h-1.5 bg-blue-500 rounded-full mt-4"></div>
                            <div className="flex">
                            ...
                            <Typography className="flex font-secondary">Did you know that providing precise and comprehensive information about your product, along with clear and captivating images, can increase its visibility on our platform by up to 15%.</Typography>
                            </div>
             </div>
        </div>
    );
